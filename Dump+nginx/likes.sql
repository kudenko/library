...
CREATE TABLE `likes` (
  ...
  CONSTRAINT `fk_likes_1` FOREIGN KEY (`book_id`) REFERENCES `books` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `likes` VALUES (4,155,1,NULL,'admin33'),(5,163,1,NULL,'admin'),(41,155,1,NULL,'admin'),(42,155,1,NULL,'admin'),(43,155,1,NULL,'admin'),(44,155,1,NULL,'admin'),(45,155,1,NULL,'admin'),(46,153,1,NULL,'admin'),(47,153,1,NULL,'user'),(48,155,1,NULL,'user'),(49,165,1,NULL,'user'),(50,164,1,NULL,'admin'),(51,163,1,NULL,'user');
...
INSERT INTO `users` VALUES (2,'admin','admin@your-site.com','admin','2d71419bc256e02fb1f9462b0fd75669',1),(10,'user','s@mail.ru','user','78f39176b1bbfc6c6fb9ee5e6fd64aa5',1),(11,'user2','ky_se_se@mail.ru','user','9e39bf21bd096b4736abd80527f8cbb7',1),(12,'admin33','test@m.ru','admin','9e39bf21bd096b4736abd80527f8cbb7',1);
...
-- Dump completed on 2017-04-18 14:31:56
